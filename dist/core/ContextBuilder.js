...
export function getDefaultAgentCwd() {
...
export function getSessionWorkDir(sessionId) {
    const now = new Date();
...
export async function buildSystemContext(basePrompt, cwd) {
...
export function getDynamicContext(cwd) {
    return `\n\n---\n\n## 当前工作目录\n${cwd}`;
}
