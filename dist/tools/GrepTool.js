...
function searchFiles(dir, regex, includeExt, results, maxResults, rootDir) {
...
export const GrepTool = {
    ...
    async execute(input) {
        ...
        if (results.length === 0)
            return { type: 'success', output: '未找到匹配内容' };
