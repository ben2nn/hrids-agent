...
import { isDangerousRemovalPath } from '../core/path-safety.js'
import { checkCommandSafetyPermission } from '../core/command-safety.js'
import { clearFileCache } from './file-read-tool.js'
